...
export default function VisionModalV2() {
  ...
  const handleSubmit = () => {
    setIsAnalyzing(true);
    setTimeout(() => {
      console.log("Visão disseminada:", vision);
      setIsOpen(false);
      setVision("");
          ...
          >
            ...
            >
              <textarea
                ...
                className="w-full bg-transparent border-none text-xl text-white placeholder-gray-700 focus:ring-0 resize-none h-40 font-light leading-relaxed focus:outline-none"
              />
              <motion.div
            ...
            >
              ...
              <motion.button
                ...
                disabled={isAnalyzing || !vision.trim()}
